...
-- NOTE: live_locations table already exists (created in earlier migration)
...
-- NOTE: tracking_subscription table already exists (created earlier)
...
-- NOTE: live_locations already added to supabase_realtime in earlier migration
-- ALTER PUBLICATION supabase_realtime ADD TABLE public.live_locations;


-- RLS Policies for live_locations
-- Staff can insert/update locations (validated in edge function)
-- NOTE: policy already exists (created in earlier migration)
...
-- NOTE: tracking_subscription policies already exist (created earlier)
